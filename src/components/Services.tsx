...
const ServiceCard: React.FC<ServiceCardProps> = ({ icon: Icon, title, description, delay = 0 }) => {
  return (
    <div 
      className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 transition-all duration-300 hover:translate-y-[-5px] hover:shadow-[0_10px_30px_rgba(44,255,190,0.1)] group animate-fade-up"
  ...
  return (
    <section id="services" className="section-padding bg-dark relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-10 relative z-10">
        <div className="text-center mx-auto max-w-3xl mb-16 animate-fade-up">
        ...
        <div className="mt-20 text-center animate-fade-up" style={{ animationDelay: '600ms' }}>
          <div className="inline-block relative">
            <div className="absolute inset-0 bg-highlight/10 blur-xl rounded-full transform scale-150 animate-pulse"></div>
            <a 
              href="#contact" 
